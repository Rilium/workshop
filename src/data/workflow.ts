...
export const adminSettingDefinitions: WorkspaceSettingDefinition[] = [
  ...
  {
    key: "mail.provider",
    value: "Google Gmail API OAuth",
    group: "mail",
    label: "Provider invii",
    helper: "Il mittente attivo si collega e si sostituisce dal BO tramite consenso Google OAuth.",
    placeholder: "Google Gmail API OAuth",
    updatedAt: "",
  },
  {
    key: "mail.fromName",
  ...
  },
  {
    ...
    group: "mail",
    label: "Rispondi a",
    helper: "Indirizzo che riceve le risposte. Il mittente reale è l'account Google collegato dal BO.",
    inputType: "email",
